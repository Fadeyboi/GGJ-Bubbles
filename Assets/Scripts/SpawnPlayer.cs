...
void AddSpriteToSquare(GameObject square, Sprite sprite)
{
    ...
    // Adjust the sprite's position and size
    Vector3 spritePosition = new Vector3(0, 0, 0); // Position below the spike
    fruitSpriteObject.transform.localPosition = spritePosition;

    fruitSpriteObject.transform.localScale = new Vector3(1f, 1f, 1f); // Adjust scale if needed
}
